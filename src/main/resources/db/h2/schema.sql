...
CREATE TABLE IF NOT EXISTS SF_TBL_BRUSH   (FARM_CODE VARCHAR(20), EQMNT_SEQ VARCHAR(10), SUB_SEQ VARCHAR(10), BRUSH_NAME  VARCHAR(100),  USE_DATE TIMESTAMP, USE_FLAG CHAR(1));
CREATE TABLE IF NOT EXISTS SF_TBL_COOLER  (FARM_CODE VARCHAR(20), EQMNT_SEQ VARCHAR(10), SUB_SEQ VARCHAR(10), COOLER_NAME VARCHAR(100),  USE_DATE TIMESTAMP, USE_FLAG CHAR(1));
CREATE TABLE IF NOT EXISTS SF_TBL_ENVIRON (FARM_CODE VARCHAR(20), EQMNT_SEQ VARCHAR(10), SUB_SEQ VARCHAR(10), ENVIRON_NAME VARCHAR(100), USE_DATE TIMESTAMP, USE_FLAG CHAR(1));
CREATE TABLE IF NOT EXISTS SF_TBL_ENVIRON_L (
  FARM_CODE    VARCHAR(20),
  EQMNT_SEQ    VARCHAR(10),
  SUB_SEQ      VARCHAR(10),
  DEVICE_NAME  VARCHAR(100),
  WRT_DATETIME TIMESTAMP,
  USE_FLAG     CHAR(1)
);
CREATE TABLE IF NOT EXISTS SF_TBL_FEEDBIN   (FARM_CODE VARCHAR(20), EQMNT_SEQ VARCHAR(10), SUB_SEQ VARCHAR(10), FEED_NAME   VARCHAR(100), USE_DATE TIMESTAMP, USE_FLAG CHAR(1));
CREATE TABLE IF NOT EXISTS SF_TBL_FEEDBIN_B (FARM_CODE VARCHAR(20), EQMNT_SEQ VARCHAR(10), SUB_SEQ VARCHAR(10), FEED_NAME   VARCHAR(100), USE_DATE TIMESTAMP, USE_FLAG CHAR(1));
CREATE TABLE IF NOT EXISTS SF_TBL_FEEDBIN_L (FARM_CODE VARCHAR(20), EQMNT_SEQ VARCHAR(10), SUB_SEQ VARCHAR(10), FEED_NAME   VARCHAR(100), USE_DATE TIMESTAMP, USE_FLAG CHAR(1));
CREATE TABLE IF NOT EXISTS SF_TBL_FOG       (FARM_CODE VARCHAR(20), EQMNT_SEQ VARCHAR(10), SUB_SEQ VARCHAR(10), FOG_NAME    VARCHAR(100),  USE_DATE TIMESTAMP, USE_FLAG CHAR(1));
CREATE TABLE IF NOT EXISTS SF_TBL_LIGHT     (FARM_CODE VARCHAR(20), EQMNT_SEQ VARCHAR(10), SUB_SEQ VARCHAR(10), LIGHT_NAME  VARCHAR(100), USE_DATE TIMESTAMP, USE_FLAG CHAR(1));
CREATE TABLE IF NOT EXISTS SF_TBL_METER     (FARM_CODE VARCHAR(20), EQMNT_SEQ VARCHAR(10), SUB_SEQ VARCHAR(10), METER_NAME  VARCHAR(100), USE_DATE TIMESTAMP, USE_FLAG CHAR(1));
CREATE TABLE IF NOT EXISTS SF_TBL_METER_S   (FARM_CODE VARCHAR(20), EQMNT_SEQ VARCHAR(10), SUB_SEQ VARCHAR(10), METER_NAME  VARCHAR(100), USE_DATETIME TIMESTAMP, USE_FLAG CHAR(1));
CREATE TABLE IF NOT EXISTS SF_TBL_ROOF      (FARM_CODE VARCHAR(20), EQMNT_SEQ VARCHAR(10), SUB_SEQ VARCHAR(10), ROOF_NAME   VARCHAR(100),  USE_DATE TIMESTAMP, USE_FLAG CHAR(1));
CREATE TABLE IF NOT EXISTS SF_TBL_STER      (FARM_CODE VARCHAR(20), EQMNT_SEQ VARCHAR(10), SUB_SEQ VARCHAR(10), STER_NAME   VARCHAR(100),  USE_DATE TIMESTAMP, USE_FLAG CHAR(1));
CREATE TABLE IF NOT EXISTS SF_TBL_STER_Q    (FARM_CODE VARCHAR(20), EQMNT_SEQ VARCHAR(10), SUB_SEQ VARCHAR(10), STER_NAME   VARCHAR(100),  USE_DATETIME TIMESTAMP, USE_FLAG CHAR(1));
CREATE TABLE IF NOT EXISTS SF_TBL_STER_V    (FARM_CODE VARCHAR(20), EQMNT_SEQ VARCHAR(10), SUB_SEQ VARCHAR(10), STER_NAME   VARCHAR(100),  USE_DATE TIMESTAMP, USE_FLAG CHAR(1));
CREATE TABLE IF NOT EXISTS SF_TBL_VEHICLE   (FARM_CODE VARCHAR(20), EQMNT_SEQ VARCHAR(10), SUB_SEQ VARCHAR(10), VEHICLE_NAME VARCHAR(100), USE_FLAG CHAR(1));
CREATE TABLE IF NOT EXISTS SF_TBL_VEHICLE_A (FARM_CODE VARCHAR(20), EQMNT_SEQ VARCHAR(10), SUB_SEQ VARCHAR(10), VEHICLE_NAME VARCHAR(100), USE_DATETIME TIMESTAMP, USE_FLAG CHAR(1));
CREATE TABLE IF NOT EXISTS SF_TBL_VENTIL    (FARM_CODE VARCHAR(20), EQMNT_SEQ VARCHAR(10), SUB_SEQ VARCHAR(10), VENTIL_NAME  VARCHAR(100), USE_DATE TIMESTAMP, USE_FLAG CHAR(1));
CREATE TABLE IF NOT EXISTS SF_TBL_VENTIL_C  (FARM_CODE VARCHAR(20), EQMNT_SEQ VARCHAR(10), SUB_SEQ VARCHAR(10), VENTIL_NAME  VARCHAR(100), USE_DATETIME TIMESTAMP, USE_FLAG CHAR(1));
CREATE TABLE IF NOT EXISTS SF_TBL_VENTIL_D  (FARM_CODE VARCHAR(20), EQMNT_SEQ VARCHAR(10), SUB_SEQ VARCHAR(10), VENTIL_NAME  VARCHAR(100), USE_DATETIME TIMESTAMP, USE_FLAG CHAR(1));
CREATE TABLE IF NOT EXISTS SF_TBL_VENTIL_P  (FARM_CODE VARCHAR(20), EQMNT_SEQ VARCHAR(10), SUB_SEQ VARCHAR(10), VENTIL_NAME  VARCHAR(100), USE_DATETIME TIMESTAMP, USE_FLAG CHAR(1));
CREATE TABLE IF NOT EXISTS SF_TBL_VENTIL_S  (FARM_CODE VARCHAR(20), EQMNT_SEQ VARCHAR(10), SUB_SEQ VARCHAR(10), VENTIL_NAME  VARCHAR(100), USE_DATETIME TIMESTAMP, USE_FLAG CHAR(1));
CREATE TABLE IF NOT EXISTS SF_TBL_WIND      (FARM_CODE VARCHAR(20), EQMNT_SEQ VARCHAR(10), SUB_SEQ VARCHAR(10), WIND_NAME    VARCHAR(100),  USE_DATE TIMESTAMP, USE_FLAG CHAR(1));
CREATE TABLE IF NOT EXISTS SF_TBL_WIND_D    (FARM_CODE VARCHAR(20), EQMNT_SEQ VARCHAR(10), SUB_SEQ VARCHAR(10), WIND_NAME    VARCHAR(100),  USE_DATE TIMESTAMP, USE_FLAG CHAR(1));